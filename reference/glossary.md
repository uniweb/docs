...
**Collection**
A set of markdown, YAML, or JSON files in `entities/` that compile into structured data, addressed through a named query. Used for blogs, team members, products — any growing catalog of items. See [Records](../authoring/collections).
