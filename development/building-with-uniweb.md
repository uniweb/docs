...
- **Parametric pages** — a `[slug]` folder becomes one page per record of a query
- **Records** — markdown, YAML or JSON files in `records/` become structured data, with automatic i18n support
